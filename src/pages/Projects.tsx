...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    photoCaptions: [
      "TBD — caption for SF Chat Queue Report.",
      "TBD — caption for SF Chat Transfer Report.",
      "TBD — caption for SF Chat Agent Productivity Report.",
      "TBD — caption for SF Chat Bi-Hourly Report.",
    ],
    category: "Tableau Visualizations",
  },
  {
    ...
    photoCaptions: [
      "TBD — caption for Agent Productivity report.",
      "TBD — caption for Queue Performance / Dept Productivity report.",
      "TBD — caption for Queue Summary Report (Yesterday).",
      "TBD — caption for Queue Summary Report (Month on Month).",
      "TBD — caption for Agent Aux Report.",
    ],
    category: "Tableau Visualizations",
  },
  {
