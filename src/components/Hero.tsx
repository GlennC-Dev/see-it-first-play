const Hero = () => {
  return (
    <section
      id="hero"
      className="relative overflow-hidden pt-12 pb-12 bg-background transition-colors duration-300"
    >
      <div className="px-[5vw] grid grid-cols-1 items-center gap-10 md:gap-16 relative z-[1]">
        <div className="max-w-[75%] md:max-w-[75%]">
          <h1 className="animate-fade-up-delay-1 font-serif-dm text-[clamp(2.4rem,3.6vw,3.2rem)] leading-[1.05] text-foreground mb-6 transition-colors duration-300 whitespace-nowrap">
